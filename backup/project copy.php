...
<a class="btn btn-warning" href="/home">REFRESH PAGE</a>
 ...
 case "changes": ?>
    ...
    <li class="view transition active"><a href="#pane8" data-toggle="tab"><i class="icon-sort-by-attributes"></i></a></li>
   ...
   case "report": ?>
    ...
    <li class="view transition"><a href="#pane6" data-toggle="tab"><i class="icon-pencil"></i></a></li>
    <li class="view transition"><a href="#pane7" data-toggle="tab"><i class="icon-user"></i></a></li>
    <li class="view transition"><a href="#pane8" data-toggle="tab"><i class="icon-sort-by-attributes"></i></a></li>
...
<!-- ********************************************************************** TROUBLE SPOT DIV  </div> -->

 <?php if($_GET['function'] == "report") { ?>
	...
	<?php if($projectData->hours_initial_planning_PROJECT > 0) { 
		...
		$planning_actual = number_format($projectData->hours_planning_PROJECT,2); ?>
	...
	<?php $planning_percent = ($planning_actual / $planning_initial)*100;?>
	     <div class="progress progress-striped active">
			 <div class="bar" style="width: <?php echo $planning_percent; ?>%;"></div></div><?php } ?>
	...
	<?php if($projectData->hours_initial_filming_PROJECT > 0) { 
		...
		$filming_actual = number_format($projectData->hours_filming_PROJECT,2); ?>
	...
	<?php $filming_percent = ($filming_actual / $filming_initial)*100;?>
	     <div class="progress progress-striped active">
			 <div class="bar" style="width: <?php echo $filming_percent; ?>%;"></div></div><?php } ?>
	...
	<?php if($projectData->hours_initial_editing_PROJECT > 0) { 
		...
		$editing_actual = number_format($projectData->hours_editing_PROJECT,2); ?>
	...
	<?php $editing_percent = ($editing_actual / $editing_initial)*100;?>
	     <div class="progress progress-striped active">
			 <div class="bar" style="width: <?php echo $editing_percent; ?>%;"></div></div><?php } ?>
	...
	<?php if($projectData->hours_initial_changes_PROJECT > 0) { 
		...
		$changes_actual = number_format($projectData->hours_changes_PROJECT,2); ?>
	...
	<?php $changes_percent = ($changes_actual / $changes_initial)*100;?>
	     <div class="progress progress-striped active">
			 <div class="bar" style="width: <?php echo $changes_percent; ?>%;"></div></div><?php } ?>
  	
	<!-- DELIVERY -->		 
	<?php if($projectData->hours_initial_delivery_PROJECT > 0) { 
		
		$delivery_initial = number_format($projectData->hours_initial_delivery_PROJECT,2);
		$delivery_actual = number_format($projectData->hours_delivery_PROJECT,2); ?>
	
	<?php if ($delivery_actual > $delivery_initial) {  $deliveryOver = $delivery_actual - $delivery_initial; ?>
	<p>Delivery - <?php echo $delivery_initial; ?> hours - <?php echo '(Used '.$delivery_actual.' hours) '; echo '<strong><i class="icon-exclamation-sign"></i> '.number_format($deliveryOver,2).' over</strong>'; ?></p>
	
	<?php  } else { 	
	$deliveryUnder = $delivery_initial - $delivery_actual; ?>
	<p>Delivery - <?php echo $delivery_initial; ?> hours - <?php echo '(Used '.$delivery_actual.' hours) ';  }?>
	<?php $delivery_percent = ($delivery_actual / $delivery_initial)*100;?>
	     <div class="progress progress-striped active">
			 <div class="bar" style="width: <?php echo $delivery_percent; ?>%;"></div></div><?php } ?>
	 ...
	 <div id="timeForm" style="display: none;">
      ...
      <p>
      <input type="text" size="5" name="hours_value"></p>
