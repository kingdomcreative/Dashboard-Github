      ...
      if(isset($_POST['queryString'])) {
         ...
         if(strlen($queryString) >0) {
			...
			if($filmFound >= 1) {
				 ...
				 echo '<ul><li class="category">Found Films</li>';
				
				 while ($filmResult = $filmQuery ->fetch_object()) {
					 
					 $urlString = titleURL($filmResult->title_VIDEO);
					 
					 printf ('<li><p class="search-proj"><a href="/project/%d/%s">%s</a></p><p class="search-film"><a href="/film/%d/%s">%s</a></p></li>',$filmResult->_kp_PROJECT,titleURL($filmResult->title_PROJECT),$filmResult->title_PROJECT,$filmResult->_kp_VIDEO,$urlString,$filmResult->title_VIDEO);
	    ...
	    echo '<li class="category" style="display: none;"><a href="sitemap/" title="Sitemap">Not found? View the Sitemap</a></li>';
