...
<a class="btn btn-warning" href="/home">REFRESH PAGE</a>
 ...
 case "changes": ?>
    <li class="view transition"><a href="#pane1" data-toggle="tab"><i class="icon-bullseye"></i></a></li>
    <?php if(!empty($projectData->notes_int_PROJECT)) { ?> <li class="view transition"><a href="#pane2" data-toggle="tab"><i class="icon-pencil"></i></a></li><?php } ?>
    <li class="view transition"><a href="#pane3" data-toggle="tab"><i class="icon-user"></i></a></li>
    <li class="view transition active"><a href="#pane4" data-toggle="tab"><i class="icon-sort-by-attributes"></i></a></li>
    <li class="view transition"><a href="#pane9" data-toggle="tab"><i class="icon-tasks"></i></a></li>
    <?php break;
   ...
   case "report": ?>
    ...
    <?php if(!empty($projectData->notes_int_PROJECT)) { ?> <li class="view transition"><a href="#pane2" data-toggle="tab"><i class="icon-pencil"></i></a></li><?php } ?>
    <li class="view transition"><a href="#pane3" data-toggle="tab"><i class="icon-user"></i></a></li>
    <li class="view transition"><a href="#pane4" data-toggle="tab"><i class="icon-sort-by-attributes"></i></a></li>
    <li class="view transition active"><a href="#pane9" data-toggle="tab"><i class="icon-tasks"></i></a></li>
    <?php break; }
    
    } else {  ?>   
    
    <li class="view transition active"><a href="#pane1" data-toggle="tab"><i class="icon-bullseye"></i></a></li>
    <?php if(!empty($projectData->notes_int_PROJECT)) { ?> <li class="view transition"><a href="#pane2" data-toggle="tab"><i class="icon-pencil"></i></a></li><?php } ?>
    <li class="view transition"><a href="#pane3" data-toggle="tab"><i class="icon-user"></i></a></li>
    <li class="view transition"><a href="#pane4" data-toggle="tab"><i class="icon-sort-by-attributes"></i></a></li>
    <li class="view transition"><a href="#pane9" data-toggle="tab"><i class="icon-tasks"></i></a></li>
 ...
 <?php if(empty($_GET['function'])) { ?>
    ...
    <p><strong>Key points to be included</strong></p>
    ...
    <p><strong>Who has ultimate approval of the project?</strong></p>
...
<div id="pane2" class="tab-pane">
    <h2 class="sub-title">Internal Notes</h2>
...
<p><strong>Editor</strong><br><?php printf('<a href="mailto:%s?subject=%s&cc=%s">%s <i class="icon-envelope-alt"></i></a>',$editorData->email_STAFF,$projectData->title_PROJECT,$prodManagerData->email_STAFF,$editorData->name_STAFF); } ?></p>
    ...
    <?php if(!empty($_GET['function']) && $_GET['function'] == "changes") { ?>
    
    <div id="pane4" class="tab-pane active"><?php } else { ?>
    
    <div id="pane4" class="tab-pane"><?php } ?>
...
<?php $projectChanges = fetchAllProjectChanges($projectData->_kp_PROJECT); 
 ...
 <?php if(!empty($_GET['function']) && $_GET['function'] == "report") { ?>
	    <div id="pane9" class="tab-pane active"><?php } else { ?>
	    <div id="pane9" class="tab-pane"><?php } ?>
	<div class="row-fluid">
	...
	<?php  if (strpos($staffData->type_STAFF, 'Production Manager') !== false) { ?>
	 <span class="span3 edit"><a class="btn btn-success" href="#" id="timeFormToggle">ADD HOURS</a></span>
	 <?php   } ?>
	...
	<?php if ($planning_actual > $planning_initial) {  $planningOver = $planning_actual - $planning_initial; ?>
	<p>Planning - <?php echo $planning_initial; ?> hours - <?php echo '(Used '.$planning_actual.' hours) '; echo '<strong><i class="icon-exclamation-sign"></i> '.number_format($planningOver,2).' over</strong>'; ?></p>
	
	<?php  } else { 	
	$planningUnder = $planning_initial - $planning_actual; ?>
	<p>Planning - <?php echo $planning_initial; ?> hours - <?php echo '(Used '.$planning_actual.' hours) '; }?>
	<?php $planning_percent = ($planning_actual / $planning_initial)*100;?>
	     <div class="progress progress-striped">
			 <?php if($planning_percent > 100) { ?>
			 <div class="bar" style="width: <?php echo $planning_percent; ?>%;background-color:#fb5a5a;"></div><?php } elseif ($planning_percent > 80) { ?>
			 <div class="bar" style="width: <?php echo $planning_percent; ?>%;background-color:orange;"></div><?php } else { ?>
			 <div class="bar" style="width: <?php echo $planning_percent; ?>%;background-color:green;"></div><?php } ?>
			 </div>
	...
	<?php if ($filming_actual > $filming_initial) {  $filmingOver = $filming_actual - $filming_initial; ?>
	<p>Filming - <?php echo $filming_initial; ?> hours - <?php echo '(Used '.$filming_actual.' hours) '; echo '<strong><i class="icon-exclamation-sign"></i> '.number_format($filmingOver,2).' over</strong>'; ?></p>
	
	<?php  } else { 	
	$filmingUnder = $filming_initial - $filming_actual; ?>
	<p>Filming - <?php echo $filming_initial; ?> hours - <?php echo '(Used '.$filming_actual.' hours) ';  }?>
	<?php $filming_percent = ($filming_actual / $filming_initial)*100;?>
	     <div class="progress progress-striped">
	     <?php if($filming_percent > 100) { ?>
			 <div class="bar" style="width: <?php echo $filming_percent; ?>%;background-color:#fb5a5a;"></div><?php } elseif ($filming_percent > 80) { ?>
			 <div class="bar" style="width: <?php echo $filming_percent; ?>%;background-color:orange;"></div><?php } else { ?>
			 <div class="bar" style="width: <?php echo $filming_percent; ?>%;background-color:green;"></div><?php } ?>
			 </div>
			 <?php } ?>
	...
	<?php if ($editing_actual > $editing_initial) {  $editingOver = $editing_actual - $editing_initial; ?>
	<p>Editing - <?php echo $editing_initial; ?> hours - <?php echo '(Used '.$editing_actual.' hours) '; echo '<strong><i class="icon-exclamation-sign"></i> '.number_format($editingOver,2).' over</strong>'; ?></p>
	
	<?php  } else { 	
	$editingUnder = $editing_initial - $editing_actual; ?>
	<p>Editing - <?php echo $editing_initial; ?> hours - <?php echo '(Used '.$editing_actual.' hours) ';  }?>
	<?php $editing_percent = ($editing_actual / $editing_initial)*100;?>
	     <div class="progress progress-striped">
			 <?php if($editing_percent > 100) { ?>
			 <div class="bar" style="width: <?php echo $editing_percent; ?>%;background-color:#fb5a5a;"></div><?php } elseif ($editing_percent > 80) { ?>
			 <div class="bar" style="width: <?php echo $editing_percent; ?>%;background-color:orange;"></div><?php } else { ?>
			 <div class="bar" style="width: <?php echo $editing_percent; ?>%;background-color:green;"></div><?php } ?>
			 </div>
			 <?php } ?>
	...
	<?php if ($graphics_actual > $graphics_initial) {  $graphicsOver = $graphics_actual - $graphics_initial; ?>
	<p>Graphics - <?php echo $graphics_initial; ?> hours - <?php echo '(Used '.$graphics_actual.' hours) '; echo '<strong><i class="icon-exclamation-sign"></i> '.number_format($graphicsOver,2).' over</strong>'; ?></p>
	
	<?php  } else { 	
	$graphicsUnder = $graphics_initial - $graphics_actual; ?>
	<p>Graphics - <?php echo $graphics_initial; ?> hours - <?php echo '(Used '.$graphics_actual.' hours) ';  }?>
	<?php $graphics_percent = ($graphics_actual / $graphics_initial)*100;?>
	     <div class="progress progress-striped">
			 <?php if($graphics_percent > 100) { ?>
			 <div class="bar" style="width: <?php echo $graphics_percent; ?>%;background-color:#fb5a5a;"></div><?php } elseif ($graphics_percent > 80) { ?>
			 <div class="bar" style="width: <?php echo $graphics_percent; ?>%;background-color:orange;"></div><?php } else { ?>
			 <div class="bar" style="width: <?php echo $graphics_percent; ?>%;background-color:green;"></div><?php } ?>
			 </div>
			 <?php } ?>
	...
	<?php if ($changes_actual > $changes_initial) {  $changesOver = $changes_actual - $changes_initial; ?>
	<p>Changes - <?php echo $changes_initial; ?> hours - <?php echo '(Used '.$changes_actual.' hours) '; echo '<strong><i class="icon-exclamation-sign"></i> '.number_format($changesOver,2).' over</strong>'; ?></p>
	
	<?php  } else { 	
	$changesUnder = $changes_initial - $changes_actual; ?>
	<p>Changes - <?php echo $changes_initial; ?> hours - <?php echo '(Used '.$changes_actual.' hours) ';  }?>
	<?php $changes_percent = ($changes_actual / $changes_initial)*100;?>
	     <div class="progress progress-striped">
			 <?php if($changes_percent > 100) { ?>
			 <div class="bar" style="width: <?php echo $changes_percent; ?>%;background-color:#fb5a5a;"></div><?php } elseif ($changes_percent > 80) { ?>
			 <div class="bar" style="width: <?php echo $changes_percent; ?>%;background-color:orange;"></div><?php } else { ?>
			 <div class="bar" style="width: <?php echo $changes_percent; ?>%;background-color:green;"></div><?php } ?>
			 </div>
			 <?php } ?>
	...
	<!-- !ADD HOURS FORM -->
	 ...
	 <div id="timeForm" style="display: none;">
      ...
      <input type="hidden" name="projectTitle" value="<?php echo $projectData->title_PROJECT; ?>"/>
      <h5>ADD HOURS</h5>
      <p><select name="hours_type" class="">
      ...
      <p><select name="staff" class="" style="width:200px">
    ...
    <p>Date:</p> <input type="text" name="hours_date" class="datepicker add-form" />
      
      <p>Hours:</p>
      <input type="text" size="5" name="hours_value" />

      
      <input type="submit" class="btn btn-success proj-form-sub" value="UPDATE">
      </form>
      </div>
...
<div class="span6 proj-info">
	...
	<p>Filming:</p> <input type="text" name="date_filming" class="datepicker add-form" value="<?php if($projectData->date_filming_PROJECT != "0000-00-00") { echo $projectData->date_filming_PROJECT; } ?>"/>
...
<div class="span12 proj-info">
    ...
    <p>What is the aim of the project?</p>
    <textarea class="add-area" name="brief1"><?php echo $projectData->brief1_aims_PROJECT; ?></textarea>
    </div>
    <div class="clearboth"></div>
    
      <div class="span6 first">
    <p>Who is the intended audience?</p>
    <textarea class="add-area" name="brief2"><?php echo $projectData->brief2_audience_PROJECT; ?></textarea>
    </div>
    <div class="clearboth"></div>
    
	<div class="span6 first">
    <p>Broadcast Channel</p>
    <textarea class="add-area" name="brief3"><?php echo $projectData->brief3_broadcast_PROJECT; ?></textarea>
    </div>
    <div class="clearboth"></div>
    
    <div class="span6 first">
    <p>Key points which need to be included</p>
    <textarea class="add-area" name="brief4"><?php echo $projectData->brief4_keypoints_PROJECT; ?></textarea>
    </div>
    <div class="clearboth"></div>
    
    <div class="span6 first">
    <p>Duration</p>
    <textarea class="add-area" name="brief5"><?php echo $projectData->brief5_duration_PROJECT; ?></textarea>
    </div>
    <div class="clearboth"></div>
    
    <div class="span6 first">
    <p>Style</p>
    <textarea class="add-area" name="brief6"><?php echo $projectData->brief6_style_PROJECT; ?></textarea>
    </div>
    <div class="clearboth"></div>
    ...
    <div class="span6 first">
    <p>Example Films</p>
    <textarea class="add-area" name="brief7"><?php echo $projectData->brief7_examples_PROJECT; ?></textarea>
    </div>
    <div class="clearboth"></div>
    
    <div class="span6 first">
    <p>Is this part of a campaign?</p>
    <textarea class="add-area" name="brief8"><?php echo $projectData->brief8_campaign_PROJECT; ?></textarea>
    </div>
    <div class="clearboth"></div>
    
    <div class="span6 first">
    <p>What graphics are required?</p>
    <textarea class="add-area" name="brief9"><?php echo $projectData->brief9_graphics_PROJECT; ?></textarea>
    </div>
    <div class="clearboth"></div>
    
    <div class="span6 first">
    <p>How will the success of the project be measured?</p>
    <textarea class="add-area" name="brief10"><?php echo $projectData->brief10_success_PROJECT; ?></textarea>
    </div>
    <div class="clearboth"></div>
...
<div class="span6 first">
 <p>Internal Notes:</p>
 <textarea class="add-area" name="notes_int"><?php echo $projectData->notes_int_PROJECT; ?></textarea>
</div>
<div class="clearboth"></div>

<div class="span6 first">
 <p>Who has ultimate project approval?</p>
 <input type="text" class="add-area" name="client_approval" value="<?php echo $projectData->brief_clientApproval_PROJECT; ?>"/>
</div>
<div class="clearboth"></div>
...
<input type="text" name="hours_planning" class="add-form" value="<?php echo $projectData->hours_initial_planning_PROJECT; ?>"/>

<p>Quoted Hours - Filming:</p>
<input type="text" name="hours_filming" class="add-form" value="<?php echo $projectData->hours_initial_filming_PROJECT; ?>" />

<p>Quoted Hours - Editing:</p>
<input type="text" name="hours_editing" class="add-form" value="<?php echo $projectData->hours_initial_editing_PROJECT; ?>"/>
...
<input type="text" name="hours_graphics" class="add-form" value="<?php echo $projectData->hours_initial_graphics_PROJECT; ?>"/>

<p>Quoted Hours - Changes:</p>
<input type="text" name="hours_changes" class="add-form" value="<?php echo $projectData->hours_initial_changes_PROJECT; ?>"/>

<!-- <p>Quoted Hours - Delivery:</p>
<input type="text" name="hours_delivery" class="add-form" value="<?php echo $projectData->hours_initial_delivery_PROJECT; ?>"/> -->
...
<div class="span6 first">
    ...
    <p>Brief Completed By:</p>
    <select name="brief_staff" class="" style="width:200px">
...
<input type="text" name="date_brief" class="datepicker add-form"  value="<?php if($projectData->_completed_brief_PROJECT != "0000-00-00") echo $projectData->_completed_brief_PROJECT; ?>"/>
...
<?php  if (strpos($staffData->type_STAFF, 'Production Manager') !== false) { 
 ...
 $taskData = fetchProjectTasksProduction($projectData->_kp_PROJECT); 
...
<ul class="single-list-tasks">
            ...
            <li><div class="film-name table-top-dark">PRODUCTION TASKS</div>
