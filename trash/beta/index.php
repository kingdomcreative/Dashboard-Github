...
<div class="span4 offset4">
	<div id="login-form">
		<h3>DASHBOARD</h3> 		<!-- <div id="last-staff"><img src="http://dashboard.circuitpro.co.uk/img/meet-Ben.png"></div> -->
      <form  action="login.php" method="post" name="staffLogin" enctype="multipart/form-data" onsubmit="return formVerify();">
        ...
        <input name="submitButtonName" type="submit" value="Log In" class="btn btn-warning"/>
      </form>
</div></div>
    </div> <!-- /container -->
