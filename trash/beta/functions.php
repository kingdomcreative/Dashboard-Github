...
function fetchAllActiveProjects($show) {
		 ...
		 try {
			...
			if($show == "all") {
			$dbProjectQuery = 'SELECT SQL_CALC_FOUND_ROWS *, DATE_FORMAT(_added_PROJECT, "%e %b %Y") AS added_PROJECT, DATE_FORMAT(date_firstDelivery_PROJECT, "%e %b %Y") AS firstDelivery_PROJECT, DATE_FORMAT(date_approval_PROJECT, "%e %b %Y") AS approval_PROJECT, DATE_FORMAT(date_finalDelivery_PROJECT, "%e %b %Y") AS finalDelivery_PROJECT FROM project LEFT JOIN client ON project._kf_client_PROJECT = client._kp_CLIENT WHERE status_PROJECT = "Active" OR status_PROJECT = "Approved" ORDER BY date_firstDelivery_PROJECT'; }
			else {
			$dbProjectQuery ='SELECT SQL_CALC_FOUND_ROWS *, DATE_FORMAT(_added_PROJECT, "%e %b %Y") AS added_PROJECT, DATE_FORMAT(date_firstDelivery_PROJECT, "%e %b %Y") AS firstDelivery_PROJECT, DATE_FORMAT(date_approval_PROJECT, "%e %b %Y") AS approval_PROJECT, DATE_FORMAT(date_finalDelivery_PROJECT, "%e %b %Y") AS finalDelivery_PROJECT FROM project LEFT JOIN client ON project._kf_client_PROJECT = client._kp_CLIENT WHERE (_kf_staff_prodManager_PROJECT = "'.$show.'" OR _kf_staff_creativeManager_PROJECT = "'.$show.'" OR _kf_staff_editor_PROJECT = "'.$show.'") AND status_PROJECT = "Active" OR status_PROJECT = "Approved" ORDER BY date_firstDelivery_PROJECT'; }
...
function fetchAllProjectTasks($projectID) {
		 ...
		 try {
			...
			$dbProjectQuery = 'SELECT SQL_CALC_FOUND_ROWS *, DATE_FORMAT(_added_TASKS, "%e %b %Y") AS added_TASKS FROM project_tasks WHERE _kf_project_TASKS = "'.$projectID.'"';
